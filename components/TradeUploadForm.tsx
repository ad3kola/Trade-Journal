                        ...
                        <SelectContent>
                          <SelectGroup>
                            ...
                            <SelectItem value="won">
                              Won <TrendingUp className="ml-1 h-4 w-4 inline" />
                            </SelectItem>
              ...
              <div className="w-full flex flex-col gap-3 p-2">
                <div className="flex flex-col justify-items-center w-full col-span-2">
                  ...
                  <input ref={screenShotRef}
                    ...
                    hidden={true}
                  />
                  <div onClick={() =>screenShotRef?.current?.click()} className="w-full bg-input rounded-2xl h-40 flex items-center justify-center text-white/80 cursor-pointer hover:scale-[1.02] duration-200 transition flex-col">
                    <CameraIcon className="h-20 w-20 text-white/50" />
                    <span className="text-[11px] tracking-wider -mt-1
                    ">*.jpg .png .jpeg</span>
                  </div>
                </div>
                <div className="flex flex-col justify-items-center w-full">
                  ...
                  <textarea
                    ...
                    className="input font-light min-h-52 pl-4 appearance-none [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                  />
                </div>
                <Button
                  className="bg-purple text-white hover:bg-white hover:text-background font-bold tracking-wider"
